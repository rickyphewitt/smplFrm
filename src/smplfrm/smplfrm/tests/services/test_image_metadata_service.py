...
class TestImageService(TestCase):
    ...
    def test_datetime_parsing(self):
        ...
        parsable_dates = [
            ...
            (
                "2014:07:25 19:39:59.283",
                datetime.datetime(2014, 7, 25, 19, 39, 59, 283000),
            ),
            (
                "2014:03:19 18:15:53+00:00",
                datetime.datetime(
                    2014, 3, 19, 18, 15, 53, tzinfo=datetime.timezone.utc
                ),
            ),
    ...
    def test_datetime_folder_structure(self):
        ...
        parsed_datetime = self.image_metadata_service.parse_date_from_path(
            image.file_path
        )

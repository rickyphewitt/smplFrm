...
class TestImagesMetadata(TestCase):
    ...
    def test_now_playing_success(self, mock_spotify_service):
        ...
        self.assertEqual(returned_json.get("artist"), self.now_playing_success.get("artist"))
        self.assertEqual(returned_json.get("song"), self.now_playing_success.get("song"))

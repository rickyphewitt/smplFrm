...
SMPL_FRM_IMAGE_REFRESH_INTERVAL = int(
    os.getenv("SMPL_FRM_IMAGE_REFRESH_INTERVAL", "30000")
)
...
SMPL_FRM_DISPLAY_WEATHER = bool(os.getenv("SMPL_FRM_DISPLAY_WEATHER", True))
...
SMPL_FRM_RESET_IMAGE_VIEW_COUNT = bool(

...
## Pull Requests
- When creating a PR that includes AI-generated or AI-assisted code, include the label `AI Assisted` on the PR
- Always squash commits so there is only one commit per PR
- PR titles should be concise (under 70 characters) — use the description for details
